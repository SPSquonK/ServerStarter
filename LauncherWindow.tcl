...
#  Jan 04, 2020 06:54:06 PM CET  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top42 {base} {
    ...
    wm geometry $top 606x260+651+842
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    place $site_3_0.but69 \
        -in $site_3_0 -x 240 -y 80 -width 37 -relwidth 0 -height 24 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but70 \
        -in $site_3_0 -x 280 -y 80 -width 37 -relwidth 0 -height 24 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but43 \
        -in $site_3_0 -x 240 -y 20 -width 37 -relwidth 0 -height 24 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but44 \
        -in $site_3_0 -x 240 -y 50 -width 37 -relwidth 0 -height 24 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but45 \
        -in $site_3_0 -x 280 -y 50 -width 37 -relwidth 0 -height 24 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but46 \
        -in $site_3_0 -x 280 -y 20 -width 37 -relwidth 0 -height 24 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but48 \
        -in $site_3_0 -x 10 -y 120 -width 137 -relwidth 0 -height 44 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but49 \
        -in $site_3_0 -x 180 -y 120 -width 137 -relwidth 0 -height 44 \
        -relheight 0 -anchor nw -bordermode ignore 
...
SquonK, 2020} -width 140 
    ...
    ###################
    place $top.lab44 \
        -in $top -x 260 -y 10 -width 330 -relwidth 0 -height 175 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab66 \
        -in $top -x 10 -y 10 -width 240 -relwidth 0 -height 245 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.mes71 \
        -in $top -x 350 -y 210 -width 140 -relwidth 0 -height 33 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.but43 \
