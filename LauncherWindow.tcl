...
#  Feb 04, 2020 09:21:26 PM CET  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top42 {base} {
    ...
    wm geometry $top 606x260+1084+535
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    wm deiconify $top
    wm title $top "SFlyFF Server Starter"
    ...
    button $site_3_0.but43 \
        ...
        -background {#d9d9d9} -disabledforeground {#a3a3a3} \
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black -pady 0 -text UP 
    ...
    button $site_3_0.but48 \
        ...
        -highlightbackground {#d9d9d9} -highlightcolor black -pady 0 \
        -text {Start Server} 
    vTcl:DefineAlias "$site_3_0.but48" "ServStart_1" vTcl:WidgetProc "Toplevel1" 1
    button $site_3_0.but49 \
        ...
        -highlightbackground {#d9d9d9} -highlightcolor black -pady 0 \
        -text {Stop Server} 
    vTcl:DefineAlias "$site_3_0.but49" "ServStart_2" vTcl:WidgetProc "Toplevel1" 1
    ...
    place $site_3_0.che46 \
        -in $site_3_0 -x 10 -y 60 -width 21 -height 25 -anchor nw \
        -bordermode ignore 
    place $site_3_0.mes52 \
        -in $site_3_0 -x 50 -y 60 -width 120 -height 23 -anchor nw \
        -bordermode ignore 
    place $site_3_0.mes58 \
        -in $site_3_0 -x 180 -y 60 -width 50 -height 23 -anchor nw \
        -bordermode ignore 
    place $site_3_0.but43 \
        -in $site_3_0 -x 240 -y 20 -width 37 -relwidth 0 -height 24 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but44 \
        -in $site_3_0 -x 240 -y 60 -width 37 -relwidth 0 -height 24 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but45 \
        -in $site_3_0 -x 280 -y 60 -width 37 -relwidth 0 -height 24 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but46 \
        -in $site_3_0 -x 280 -y 20 -width 37 -relwidth 0 -height 24 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but48 \
        -in $site_3_0 -x 10 -y 100 -width 137 -relwidth 0 -height 44 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but49 \
        -in $site_3_0 -x 180 -y 100 -width 137 -relwidth 0 -height 44 \
        -relheight 0 -anchor nw -bordermode ignore 
    ...
    message $top.mes71 \
        ...
        -text {SFlyFF Server Starter
SquonK, 2020} -width 140 
    ...
    button $top.but44 \
        ...
        -highlightbackground {#d9d9d9} -highlightcolor black -pady 0 \
        -text Git 
    vTcl:DefineAlias "$top.but44" "GitButton" vTcl:WidgetProc "Toplevel1" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.lab44 \
        -in $top -x 260 -y 10 -width 330 -relwidth 0 -height 155 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab66 \
        -in $top -x 10 -y 10 -width 240 -relwidth 0 -height 245 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.mes71 \
        -in $top -x 360 -y 210 -width 140 -relwidth 0 -height 33 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.but43 \
        -in $top -x 260 -y 210 -width 97 -relwidth 0 -height 34 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.but44 \
        -in $top -x 490 -y 210 -width 97 -relwidth 0 -height 34 -relheight 0 \
        -anchor nw -bordermode ignore 
