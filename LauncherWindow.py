...
#    Mar 31, 2019 03:19:23 AM CEST  platform: Windows NT
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Labelframe1.place(relx=0.02, rely=0.033, relheight=0.928
                , relwidth=0.47)
        ...
        self.Labelframe2.place(relx=0.509, rely=0.033, relheight=0.798
                , relwidth=0.47)
        ...
        self.Message1.place(relx=0.724, rely=0.847, relheight=0.107
                , relwidth=0.254)
        ...
        self.Message1.configure(text='''FlyFF Server Launcher
SquonK, 2019''')
        self.Message1.configure(width=130)

        self.menubar = tk.Menu(top,font="TkMenuFont",bg=_bgcolor,fg=_fgcolor)
        top.configure(menu = self.menubar)

        self.OpenFlyFFDir = tk.Button(top)
        self.OpenFlyFFDir.place(relx=0.509, rely=0.847, height=34, width=97)
        ...
        self.OpenFlyFFDir.configure(text='''Open FlyFF Dir''')

        self.GitButton = tk.Button(top)
        self.GitButton.place(relx=0.939, rely=0.912, height=24, width=27)
        ...
        self.GitButton.configure(width=27)
