...
#    Jan 04, 2020 06:54:08 PM CET  platform: Windows NT
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Labelframe1.place(relx=0.429, rely=0.038, relheight=0.673
                , relwidth=0.545)
        ...
        self.ServMsg01.place(relx=0.152, rely=0.114, relheight=0.131
        ...
        self.ServState01.place(relx=0.545, rely=0.114, relheight=0.131
        ...
        self.ServCbx01.place(relx=0.03, rely=0.114, relheight=0.143
        ...
        self.ServCbx02.place(relx=0.03, rely=0.286, relheight=0.143
                , relwidth=0.064, bordermode='ignore')
        ...
        self.ServCbx03.place(relx=0.03, rely=0.457, relheight=0.143
                , relwidth=0.064, bordermode='ignore')
        ...
        self.ServMsg02.place(relx=0.152, rely=0.286, relheight=0.131
                , relwidth=0.364, bordermode='ignore')
        ...
        self.ServMsg03.place(relx=0.152, rely=0.457, relheight=0.131
                , relwidth=0.364, bordermode='ignore')
        ...
        self.ServState02.place(relx=0.545, rely=0.286, relheight=0.131
                , relwidth=0.152, bordermode='ignore')
        ...
        self.ServState03.place(relx=0.545, rely=0.457, relheight=0.131
                , relwidth=0.152, bordermode='ignore')
        ...
        self.ServStart.place(relx=0.727, rely=0.457, height=24, width=37
                , bordermode='ignore')
        ...
        self.ServStart.configure(text='''UP''')
        self.ServStart.configure(width=37)

        self.ServStop = tk.Button(self.Labelframe1)
        self.ServStop.place(relx=0.848, rely=0.457, height=24, width=37
                , bordermode='ignore')
        ...
        self.ServStop.configure(text='''KILL''')
        self.ServStop.configure(width=37)

        self.Button1 = tk.Button(self.Labelframe1)
        self.Button1.place(relx=0.727, rely=0.114, height=24, width=37
                , bordermode='ignore')
        ...
        self.Button2.place(relx=0.727, rely=0.286, height=24, width=37
                , bordermode='ignore')
        ...
        self.Button2.configure(text='''UP''')
        self.Button2.configure(width=37)

        self.Button3 = tk.Button(self.Labelframe1)
        self.Button3.place(relx=0.848, rely=0.286, height=24, width=37
                , bordermode='ignore')
        ...
        self.Button3.configure(text='''KILL''')
        self.Button3.configure(width=37)

        self.Button4 = tk.Button(self.Labelframe1)
        self.Button4.place(relx=0.848, rely=0.114, height=24, width=37
                , bordermode='ignore')
        ...
        self.Button4.configure(text='''KILL''')
        self.Button4.configure(width=37)

        self.ServStart_1 = tk.Button(self.Labelframe1)
        self.ServStart_1.place(relx=0.03, rely=0.686, height=44, width=137
                , bordermode='ignore')
        ...
        self.ServStart_1.configure(width=137)

        self.ServStart_2 = tk.Button(self.Labelframe1)
        self.ServStart_2.place(relx=0.545, rely=0.686, height=44, width=137
                , bordermode='ignore')
        ...
        self.ServStart_2.configure(width=137)

        self.Labelframe2 = tk.LabelFrame(top)
        self.Labelframe2.place(relx=0.017, rely=0.038, relheight=0.942
                , relwidth=0.396)
        ...
        self.Message1.place(relx=0.578, rely=0.808, relheight=0.127
                , relwidth=0.231)
...
SquonK, 2020''')
        ...
        self.OpenFlyFFDir.place(relx=0.429, rely=0.808, height=34, width=97)
        ...
        self.OpenFlyFFDir.configure(text='''Dir''')
        self.OpenFlyFFDir.configure(width=97)

        self.GitButton = tk.Button(top)
        self.GitButton.place(relx=0.809, rely=0.808, height=34, width=97)
        ...
        self.GitButton.configure(text='''Git''')
        self.GitButton.configure(width=97)
